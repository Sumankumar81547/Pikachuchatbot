...
BOT_USERNAME = os.environ.get("BOT_USERNAME","@Pikachu_Xchatbot") 
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","DEVIL_WORLD_473")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","Pikachu_XD_23")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","DEVIL_WORLD_474")
...
SOURCE = 'https://github.com/telegrambot622/AMRITCHATBOT'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
...
async def restart(client, m: Message):
        ...
        await accha.edit("🦋𝗡𝗢𝗪 𝗖𝗢𝗠𝗘 𝗛𝗘𝗥𝗘 👉 @AMRIT_X_SUPPORTS, @AMRIT_X_SUPPORT , @its_mcqs_1 𝗔𝗡𝗗 𝗠𝗔𝗞𝗘 𝗬𝗢𝗨𝗥 𝗚𝗜𝗥𝗟𝗙𝗥𝗜𝗡𝗗 🥀💋 𝗜𝗙 𝗬𝗢 𝗛𝗔𝗩𝗘 𝗔 𝗚𝗜𝗥𝗟𝗙𝗜𝗘𝗡𝗗  😘 𝗧𝗛𝗘𝗡 𝗬𝗢𝗨 𝗪𝗜𝗟𝗟 𝗚𝗜𝗙𝗧 🙊 𝗧𝗢 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 @amrit_Koniki ❤️")
